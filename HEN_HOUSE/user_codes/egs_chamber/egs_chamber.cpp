...
public:
    ...
    ~EGS_ChamberApplication() {
        ...
        if (*multiFlag_Martinov) {
            if (doses_Martinov) {
                for (int i = 0; i < doses_Martinov->size(); i++)
                    if((*doses_Martinov)[i])  delete (*doses_Martinov)[i];
            ...
            if (masses_Martinov) {
                for (int i = 0; i < masses_Martinov->size(); i++)
                    if ((*masses_Martinov)[i])  delete (*masses_Martinov)[i];
                doses_Martinov->clear();
        ...
        for (int i = 0; i < cavity_regions.size(); i++)
            if(cavity_regions[i])  delete[] cavity_regions[i];

        if (multiFlag_Martinov)  delete multiFlag_Martinov;
        // Martinov Stop  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //  
        // Martinov Start ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //
        // destructors for all the variables defined for multiregion scoring
        if (*edepEventFlag_Martinov)
            if (edepEvent_Martinov)  {
                for (int i = 0; i < edepEvent_Martinov->size(); i++)
                    if((*edepEvent_Martinov)[i])  delete (*edepEvent_Martinov)[i];
                    edepEvent_Martinov->clear();
                    delete edepEvent_Martinov;
                }

        if (edepEventFlag_Martinov)  delete edepEventFlag_Martinov;
        if (edepDropZeroFlag_Martinov)   delete edepDropZeroFlag_Martinov;
        // Martinov Stop  ~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~~ //  
